...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#2a3941] text-white flex flex-col items-center">
      ...
      {/* Call to Action */}
      <section className="mt-16 bg-[#496e6e] w-full text-center py-10">
        <h3 className="text-2xl font-semibold">Join Pescador Today</h3>
        <p className="mt-2">
          Save locations, log trips, and get the best fishing insights.
        </p>
